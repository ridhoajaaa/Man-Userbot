...
# Support
GROUP = os.environ.get("GROUP", "demonszxx")
CHANNEL = os.environ.get("CHANNEL", "ppppppppppppppppqq")
...
WEATHER_DEFCITY = os.environ.get("WEATHER_DEFCITY", "Makassar")
...
ALIVE_TEKS_CUSTOM = os.environ.get("ALIVE_TEKS_CUSTOM", "Alo. Saya hidup banh")

# Default .alive name
ALIVE_NAME = os.environ.get("ALIVE_NAME", "Dodo")
...
# Default .alive logo
ALIVE_LOGO = (
    os.environ.get("ALIVE_LOGO") or "https://telegra.ph/file/555025b07d889eed5d561.jpg"
)
        ...
        async def inline_handler(event):
            ...
            if event.query.user_id == uid and query.startswith("@SharingUserbot"):
                ...
                result = builder.article(
                    ...
                    buttons=[
                        [
                            custom.Button.url("ɢʀᴏᴜᴘ", "https://t.me/demonszxx"),
                            custom.Button.url(
                                "ʀᴇᴘᴏ", "https://xnxx.com"
                            ),
                        ],
                ...
                result = builder.article(
                    title="✗ Man-Userbot ✗",
                    description="Dodo - UserBot | Telethon",
                    url="https://t.me/SharingUserbot",
                    thumb=InputWebDocument(INLINE_PIC, 0, "image/jpeg", []),
